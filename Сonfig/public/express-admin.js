...
//<script src="@ckeditor/ckeditor5-build-classic"></script>
/*<script>
...
$(function () {
    ...
    $('td').each(function() {
          ...
          if (html.indexOf('```javascript')>0)
                {
                    $(this).html(html.replaceAll('```javascript','<pre><code class="lang-javascript" style="height:100px;overflow-y: scroll">').replaceAll('```\n','</code></pre>\n')); }
          if (html.indexOf('```css')>0)
                {
                  $(this).html(html.replaceAll('```css','<pre><code class="lang-css" style="height:100px;overflow-y: scroll">').replaceAll('```\n','</code></pre>\n')); }
          if (html.indexOf('```html')>0)
                {
                  $(this).html(html.replaceAll('```html','<pre><code class="lang-html" style="height:100px;overflow-y: scroll">').replaceAll('```\n','</code></pre>\n')); }
          if (html.indexOf('```python')>0)
                {
                  $(this).html(html.replaceAll('```python','<pre><code class="lang-python" style="height:100px;overflow-y: scroll">').replaceAll('```\n','</code></pre>\n')); }
        }
