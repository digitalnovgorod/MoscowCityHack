...
// BRITIN 09.2020 begin ADD sertificate
//    var sert = fs.readFileSync('ssl/root.crt');
//    options['ssl']['ca']=sert;
// 09.2020 end ADD sertificate
    ...
    this.connection.query(sql, function (err, rows) {
      // BRITIN
        if (err) {
            ...
            options['ssl']['ca']=sert;
            this.connection = this.client.createConnection(options);
            this.connection.connect(this.options,function reselect() {
              this.connection.query(sql, function (err, rows) {
              done(null, rows); });
            });
